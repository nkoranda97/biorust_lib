...
class DNA:
    ...
    def translate(
        ...
        Args:
            frame: Reading frame selection. None (default) requires the sequence
                length to be a multiple of 3. Frame 1/2/3 offsets by 0/1/2 bases
                and silently drops trailing bases. "auto" picks the frame with the
                longest ORF (first M to next * or end).

        Raises:
            ValueError: If frame is None and sequence length is not a multiple of 3
        """
        ...
